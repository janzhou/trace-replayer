...
extern sensors_socket_data socket_data[50];
extern int socket_data_count;
extern int socket_data_max;	

//#define socket_insert(el)  sensors_add_array_el( \ 
//	(el), &socket_data, &socket_data_count,\ 
//	&socket_data_max, sizeof( struct sensors_socket_data))
